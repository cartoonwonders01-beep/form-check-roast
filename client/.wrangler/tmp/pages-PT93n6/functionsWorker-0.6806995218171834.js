...
- Joint Angles: Elbow: ${Math.round(poseTelemetry.angles?.elbow || 180)}\xB0, Hip Sag: ${Math.round(poseTelemetry.angles?.hip || 180)}\xB0, Shoulder Flare: ${Math.round(poseTelemetry.angles?.shoulder || 50)}\xB0
...
// ../.wrangler/tmp/pages-PT93n6/functionsRoutes-0.26677507062909744.mjs
var routes = [
  {
    routePath: "/api/roast",
    mountPath: "/api",
